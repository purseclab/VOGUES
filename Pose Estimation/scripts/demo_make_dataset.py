...
def run_on_video(vidfile):
    mode, input_source = check_input(vidfile)
...
if __name__ == "__main__":
    image_files_directory = "C:\\Users\\raymo\\Downloads\\UCF101\\*\\*.avi"
    job = 0
    for vidfile in glob.iglob(image_files_directory):
        #WENT TO 801
        if(job < 802):
            job += 1
            continue
